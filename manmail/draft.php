                    ...
                    <div class="position-sticky">
                        <ul class="nav flex-column">
                            ...
                            <li class="compose">
                                ...
                                <button class=btn class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><a href="dashboard.php?composeid=<? echo $_SESSION['id'] ?>">Compose</a></button>
                            </li>
