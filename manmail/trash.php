...
if ($_SESSION['login']) {
    ...
    if (isset($_POST["delete_all"]) && $_POST["delete_all"] != "") {
        $email = $_SESSION['email'];
        $result = $obj->trashall_delete($email);
    }
    ...
    if (isset($_POST["submit_sent"]) && $_POST["submit_sent"] != "") {
        ...
        $email = $_SESSION['email'];
        $message_id = $_POST['message_trash'];
        $result = $obj->trash_delete_data($email, $message_id);
    }
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr id="color">
                                                            ...
                                                            <td class="col-4"><?php echo $row['to_send'] ?></td>
...
if (isset($_SESSION['trash_delete']) && $_SESSION['trash_delete'] != '') {

?>
    <script>
        swal({
            title: "<?php echo $_SESSION['trash_delete']  ?>",
            text: "",
            icon: "<?php echo $_SESSION['trash_code']  ?>",
            button: "Ok Done",
        });
    </script>
<?php
    unset($_SESSION['trash_delete']);
}
?>
...
if (isset($_SESSION['deleteall_trash']) && $_SESSION['deleteall_trash'] != '') {

?>
    <script>
        swal({
            title: "<?php echo $_SESSION['deleteall_trash']  ?>",
            text: "",
            icon: "<?php echo $_SESSION['delete_trash']  ?>",
            button: "Ok Done",
        });
    </script>
<?php
            ...
            $(document).on("click", ".mesaagedetail", function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        html += "<div style='font-size:25px'>Date : " + response[0]['date_time'] + "</div>";
